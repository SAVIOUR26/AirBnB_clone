...
class HBNBCommand(cmd.Cmd):
    ...
    def do_quit(self, arg):
        """Quitting command to exit the program."""
        return True
    ...
    def do_show(self, arg):
        """Usage: showing <class> <id> or <class>.show(<id>)
    ...
    def do_update(self, arg):
       ...
       <class>.updating(<id>, <attribute_name>, <attribute_value>) or
       <class>.updating(<id>, <dictionary>)
